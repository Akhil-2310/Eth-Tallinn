...
contract UserSide{
    ...
    mapping(uint256 => string) public daoIdtoGrpId;
    ...
    function storeGrpId(uint256 _daoId,string memory _grpId) public {
        uint256 daoCreatorId = daoIdtoDao[_daoId].creator;
        uint256 tempUserId = userWallettoUserId[msg.sender];
        require(daoCreatorId == tempUserId,"Only Admin can create group");
        daoIdtoGrpId[_daoId] = _grpId; 
    }
